...
@section('content')
    ...
    <div class="container" id="creer_article" style="padding-top: 5%;display: none">
        <div class="row text-center">
            <div class="col-md-12">
                <!-------------------------------------------CREER UN ARTICLE--------------------------------------------------------->
    ...
    <!------------------------------------------------LISTE DES ARTICLES------------------------------------->
    <div class="container" id="liste_article" style="padding-top: 5%;display: none">
        <div class="row text-center">
            <div class="col-md-12">
                <div class="mb-3">
    ...
    <!-----------------------------------------CREER UNE GAMME--------------------------------------------->
    <div class="container" id="creer_gamme" style="padding-top: 5%;display: none">
        <div class="row text-center">
            <div class="col-md-12">
    ...
    <!---------------------------------------LISTE DES GAMMES----------------------------------------------------->
    <div class="container" id="liste_gamme" style="padding-top: 5%;display: none">
        <div class="row text-center">
            <div class="col-md-12">
                <div class="mb-3">
    ...
    <div class="container" id="creer_campagne" style="padding-top: 5%;display: none">
        <div class="row text-center">
            <div class="col-md-12">
    ...
    <!-------------------------------------------LISTE DES CAMPAGNES--------------------------------------------->
    <div class="container" id="liste_campagne" style="padding-top: 5%;display: none">
        <div class="row text-center">
            <div class="col-md-12">
                <div class="mb-3">
    ...
    <div class="container" id="liste_utilisateur" style="padding-top: 5%;display: none">
        <div class="row text-center">
            <div class="col-md-12">
                <div class="mb-3">
                    <!-- On parcourt la liste des campagnes -->
